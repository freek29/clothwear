  ...
  <div className="container px-5 md:pl-24 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      ...
      <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
         ...
         <Image src='/logo.png' alt='lg' width={356} height={88}/>
        
      </a>
      </Link>
      <p className="mt-2 text-sm text-gray-500 mx-8">Wear The &lt;Code/&gt; </p>
      <p className="text-sm text-gray-500 mx-8">Premium coding Tshirts , Hoodies and Apparels</p>
    </div>
