  ...
  return (
    <div className='container mx-auto my-9'>
      ...
      <div className='mx-4 md:mx-20'>
        ...
        <button onClick={handleUserSubmit} className="flex m-2 mb-5 text-white bg-pink-500 border-0 py-1.5 px-2 focus:outline-none hover:bg-pink-600 rounded text-sm">Submit</button>
        ...
        <form className='mx-auto flex my-2'>
          <div className='px-2 w-1/2'>
            <div className="mb-4">
              ...
              <input onChange={handleChange} autoComplete="off" value={password} type="password" id="password" name="password" className="w-full bg-white rounded border border-gray-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
            </div>
          </div>
          ...
          <div className='px-2 w-1/2'>
            <div className="mb-4">
              ...
              <input onChange={handleChange} autoComplete="off" value={npassword} type="password" id="npassword" name="npassword" className="w-full bg-white rounded border border-gray-300 focus:border-pink-500 focus:ring-2 focus:ring-pink-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
            </div>
          </div>
        ...
        <button onClick={handlePasswordSubmit} className="flex m-2 text-white bg-pink-500 border-0 py-1.5 px-2 focus:outline-none hover:bg-pink-600 rounded text-sm">Submit</button>
      </div>
    </div>
  )
}
